...
Neural prolotherapy is a treatment which uses a shallow (subcutaneous) injection of a 5% dextrose (sugar) solution under the skin. This treatment focuses on relieving pressure on an impinged nerve by creating a hydrodissection (water pillow) in the area surrounding the nerve. The dextrose solution also down-regulates the TRPV1 receptors (pain receptors) on the surface of the nerve. Neural prolotherapy was first discovered by Dr. John Lyftogt, a medical doctor from New Zealand. Dr. Lyftogt successfully used this treatment on himself to recover from his own chronic case of Achilles tendinitis. Following his recovery Dr. Lyftogt has traveled the world teaching this treatment to other doctors. Read more on [neural prolotherapy](/neural-prolotherapy-pain).

...
- **Provocation tests:** A cluster of physical examination tests (including the FABER test, thigh thrust, distraction and compression tests) are used to stress the SI joint and reproduce the patient's pain. A positive cluster of three or more tests improves diagnostic accuracy.<sup>2</sup>
...
**Prolozone therapy** combines ozone gas with proliferant solutions to enhance tissue oxygenation and healing at the injection site. This can be particularly useful in cases where the local tissue environment is compromised. Learn more about [prolozone therapy](/prolozone).
...
2. van der Wurff P, Buijs EJ, Groen GJ. A multitest regimen of pain provocation tests as an aid to reduce unnecessary minimally invasive sacroiliac joint procedures. *Arch Phys Med Rehabil*. 2006;87(1):10-14.
3. Cusi M, Saunders J, Hungerford B, Wisbey-Roth T, Lucas P, Wilson S. The use of prolotherapy in the sacroiliac joint. *Br J Sports Med*. 2010;44(2):100-104.
4. Hauser RA, Hauser MA, Cukla JJ. A retrospective observational study on dextrose prolotherapy for unresolved low back pain and sacroiliac joint dysfunction. *J Prolotherapy*. 2009;1(3):145-155.
